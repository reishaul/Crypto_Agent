...
// This file defines the AI-related routes for the application, specifically for generating investment advice based on user preferences.

const router = express.Router();// Define a POST route for generating AI advice based on investor type and crypto assets


// Define a POST route for generating AI advice based on investor type and crypto assets
